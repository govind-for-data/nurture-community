...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Yug Society works with rural communities across India in education, healthcare, women empowerment, and the environment.",
      cta1: "Donate Now",
    ...
    about: {
      ...
      body: "Yug Society is a non-profit organisation working hand-in-hand with underserved communities. We believe real change happens when people lead their own transformation — and we walk beside them every step of the way.",
    ...
    contact: {
      ...
      address: "Village - Danpow, P.O. - Bhatronjkhan, District - Almora, Uttrakhanda - 263646",
      phoneLabel: "Phone",
      emailLabel: "Email",
      name: "Your name",
      email: "Email address",
  ...
  hi: {
    ...
    hero: {
      ...
      subtitle: "युग सोसाइटी भारत के ग्रामीण समुदायों के साथ शिक्षा, स्वास्थ्य, महिला सशक्तिकरण और पर्यावरण के क्षेत्र में कार्य करता है।",
      cta1: "अभी दान करें",
      cta2: "स्वयंसेवक बनें",
    },
    about: {
      ...
      body: "युग सोसाइटी एक गैर-लाभकारी संगठन है जो वंचित समुदायों के साथ कंधे से कंधा मिलाकर काम करता है। हम मानते हैं कि असली बदलाव तब होता है जब लोग स्वयं अपना परिवर्तन करते हैं।",
